...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs/config_a2c.yaml --agent_id=112 --env=CarlaGymEnv-v5 --planner_mode=continuous_catagorical --learning_rate=7e-3
