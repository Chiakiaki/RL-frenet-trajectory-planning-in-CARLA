...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs/config_a2c_LSTM.yaml --agent_id=111 --env=CarlaGymEnv-v5 --planner_mode=continuous_catagorical
