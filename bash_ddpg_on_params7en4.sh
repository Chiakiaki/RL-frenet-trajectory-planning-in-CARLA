...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs/config_ddpg.yaml --agent_id=44440 --env=CarlaGymEnv-v5 --learning_rate=7e-4 --planner_mode=ddpg_on_params
