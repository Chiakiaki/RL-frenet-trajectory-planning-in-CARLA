...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs_10vehicles/config_ppo.yaml --agent_id=5560 --env=CarlaGymEnv-v5 --learning_rate=7e-4 --planner_mode=catagorical
