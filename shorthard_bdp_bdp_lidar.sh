...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs_10vehicles/config_bdp_2400len.yaml --agent_id=5580 --env=CarlaGymEnv-v5 --learning_rate=7e-4 --planner_mode=bdp --is_finish_traj=0 --use_lidar=1 --short_hard=1
