...
python3 ./run_BDPL.py -p $port --tm_port $port_tm --cfg_file=tools/cfgs_10vehicles/config_trpo_2400len.yaml --test --env=CarlaGymEnv-v5 --learning_rate=7e-4 --planner_mode=catagorical --is_finish_traj=0 --use_lidar=1 --short_hard=1 --env_change=pertubation --test_dir /test/shorthard_trpo_catagorical_15traj --num_traj=15
